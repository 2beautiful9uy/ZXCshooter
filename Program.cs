...
namespace ZXCKalista
{
    class Program
    {
        ...
        static void Loading_OnLoadingComplete(EventArgs args)
        {
            ...
            Kalistamenu.Add("useq",new CheckBox("Sexy Q in Combo"));
            Kalistamenu.AddSeparator();
            Kalistamenu.Add("combo2",new CheckBox("Let it Fly [take care of this]", false));
            Kalistamenu.AddSeparator();
            Kalistamenu.Add("aad",new CheckBox("Show Attack Range"));
